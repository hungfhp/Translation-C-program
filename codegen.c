...
int computeNestedLevel(Scope* scope) {
  // TODO
  int level = 0;
  Scope* tmp_scope = symtab -> currentScope;
...
void genVariableAddress(Object* var) {
  // TODO
  genLA(computeNestedLevel(var -> varAttrs -> scope),
        var -> varAttrs -> localOffset);
}

void genVariableValue(Object* var) {
  // TODO
  genLV(computeNestedLevel(var -> varAttrs -> scope), 
        var -> varAttrs -> localOffset);
}
...
void genParameterAddress(Object* param) {
  // TODO
    ...
    genLA(computeNestedLevel(param->paramAttrs->scope),
          param->paramAttrs->localOffset);
...
void genParameterValue(Object* param) {
  // TODO
    ...
    genLV(computeNestedLevel(param->paramAttrs->scope),
          param->paramAttrs->localOffset);
...
void genProcedureCall(Object* proc) {
  // TODO
  genCALL(computeNestedLevel(proc -> procAttrs -> scope -> outer),
          proc -> procAttrs -> codeAddress);
}
...
void genFunctionCall(Object* func) {
  // TODO
  genCALL(computeNestedLevel(func -> funcAttrs -> scope -> outer),
          func -> funcAttrs -> codeAddress);
}
